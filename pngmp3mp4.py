...
def jpg_mp4(mp3):
    os.system("ffmpeg -r 1/60 -i img%02d.jpg -i " + mp3 + " -vcodec mpeg4 -y movie4.mp4")


def jpeg_mp4(mp3):
    os.system("ffmpeg -r 1/60 -i img%02d.jpeg -i " + mp3 + " -vcodec mpeg4 -y movie4.mp4")
...
print("Devi inserire file immmagine che si chiamano img01 img02 ecc.")
print(*os.listdir(), sep="\n")
ans = input("1 = png \n 2 = PNG\n>")
if ans == "1":
    png_mp4(input("Nome del file mp3: "))
else:
    PNG_mp4(input("Nome del file mp3: "))
